...
class QuestionGenService
  ...
  def question_type_prompt(question_type)
    ...
    when "code_analysis"
      <<~CODE_ANALYSIS
        Una pregunta de múltiple opción del tipo **Análisis de Código** proporciona un fragmento de código y solicita a los estudiantes que detecten errores, agreguen instrucciones para mejorar el código o usen el código de una manera nueva.
        Este es el tipo de pregunta que debes generar.
      CODE_ANALYSIS
    else
      "Generate a question."
